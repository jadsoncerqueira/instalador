...
```bash
sudo apt install -y git && git clone https://github.com/jadsoncerqueira/instalador.git && sudo chmod -R 777 instalodordeploy && cd instalador&& sudo ./install_primaria
```
